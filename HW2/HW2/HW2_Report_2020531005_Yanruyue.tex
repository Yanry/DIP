...
\vspace*{1.5ex} \textbf{\large{Name: Yan Ruyue, ID: 2020531005}}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=15cm]{images/p1a.jpg}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=8cm]{images/p1b_h.jpg}
	\caption{transfer function H}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{images/p1b_result.jpg}
	\caption{result}
\end{figure}
\hspace*{\fill} \\
Use replicate padding on the figure before FFT
...
\begin{figure}[h]
	\centering
	\includegraphics[width=5cm]{images/p2_h.jpg}
	\caption{transfer function H}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{images/p2_result.jpg}
	\caption{original(left)  result(right)}
\end{figure}
\hspace*{\fill} \\
Use parameters $D_0 = 30, \gamma_l=0.8, \gamma_h = 3, c = 4$, the variance within the white box is 0.0414
...
\begin{figure}[h]
	\centering
	\includegraphics[width=8cm]{images/p3_hsi.jpg}
	\caption{HSI image}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=8cm]{images/p3_rgb.jpg}
	\caption{recovered RGB image}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=8cm]{images/p4a.jpg}
\end{figure}
...
\hspace*{\fill} \\
\texttt{theta} = -55 degree\\
\texttt{d} = 15, \texttt{L=N/d}=42.667\\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=15cm]{images/p4c.jpg}
\end{figure}
